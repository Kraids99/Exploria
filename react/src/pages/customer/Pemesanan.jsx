...
export default function Pemesanan() {
    ...
    const berangkat = detailTiket.waktu_keberangkatan?.substring(11, 16) || "--:--";
    ...
    const renderSeatButton = (seat, fallbackLabel) => {
        ...
        return (
            <button
                ...
                className={`${base} ${isBooked ? booked : isSelected ? selected : available
                    }`}
            >
            ...
            <main className="min-h-screen bg-gray-50 pb-16">
                <section className="max-w-6xl mx-auto px-4 pt-10 space-y-8">
                    ...
                    <div className=" bg-white rounded-2xl shadow px-6 py-5">
                        ...
                        <div className="flex flex-wrap items-center gap-6 text-center justify-center">
                            {["Pesan", "Review", "Bayar", "E-Ticket"].map((label, idx) => (
                                ...
                                >
                                    <div
                                        className={`w-8 h-8 flex items-center justify-center rounded-full border-2 ${idx === 0
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                        ...
                        <section className="bg-white rounded-2xl shadow p-6">
                            ...
                            <div className="flex items-center justify-center gap-5 mb-6 text-xs text-slate-500">
                            ...
                            {/* Body bus */}
                            <div className="m-auto w-80 max-w-md bg-slate-50 rounded-2xl border border-slate-200 p-10">
                                {/* Sopir di atas */}
                                <div className="flex px-40 mb-5">
                        ...
                        <section className="bg-white rounded-2xl shadow p-6 flex flex-col gap-6">
                            <div>
                                ...
                                <div className="grid grid-cols-3 text-sm space-y-1 mb-4">
                                    <div>
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="text-sm font-semibold">{tujuanTerminal}</p>
                                ...
                                <div className="text-sm space-y-2">
                                    <div className="flex justify-between">
                                        <span className="text-slate-600">Nomor tempat duduk</span>
