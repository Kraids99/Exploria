        ...
        <section className="w-full flex justify-center mt-6 px-4">
          <div className="relative w-full max-w-5xl">
            ...
            <div className="absolute bottom-4 left-4 sm:left-8 text-white">
              <h2 className="text-2xl sm:text-3xl font-bold">Bandung</h2>
              <p className="text-sm sm:text-base">
                Metropolis City of Tourism
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mt-6 px-4">
          <div className="max-w-3xl mx-auto">
            <p className="text-sm sm:text-base text-blue-950 leading-relaxed">
              Kota Bandung dikenal dengan wisata kuliner, alam, dan suasana
              kotanya yang sejuk.
            </p>
          </div>
        </section>
